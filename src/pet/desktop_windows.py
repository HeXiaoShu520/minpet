...
def show_chat_window(owner, history=None, append_message=None, content_for_llm=None, system_prompt_builder=None, clear_history_callback=None, send_callback=None, backend='builtin', backend_select_callback=None):
    ...
    if owner.chat_window is None:
        ...
        owner.chat_window.backend_select_callback = backend_select_callback
