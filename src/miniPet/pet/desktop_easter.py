...
from miniPet.widgets.easter import CoinPopup, DicePopup, FortuneStickPopup, GachaPopup, MagicConchPopup, WoodenFishPopup
from miniPet.widgets.menus.pet_menus import PetEasterMenu
...
def show_fortune_result(owner, level, text):
    x, y = owner.bubble_anchor()
    owner.bubble_requested.emit(f'【{level}】{text}', x, y, 7000)
